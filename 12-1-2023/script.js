...
// forEach
const onlyIDs = todos.forEach((todo) => console.log(todo.id));

// Map
const allUserId = todos.map((todo) => console.log(todo.userId));

// Filter
const moreThan4 = todos.filter((todo) => console.log(todo.id >= 4));
